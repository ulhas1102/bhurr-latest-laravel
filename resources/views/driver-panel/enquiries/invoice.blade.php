...
<body>
  ...
  <div class="modal fade" id="customizeInvoice" tabindex="-1" role="dialog" aria-labelledby="customizeInvoiceModalLabel" aria-hidden="true">
    ...
    <div class="buttonbox" style="text-align: center; justify-content:space-evenly; margin-top:20px;margin-bottom:20px;">
        <a href="{{ route('driver.download.invoice', $enquiry->enquiry_id) }}" class="btn btn-primary" style="padding-left: 18px; padding-right: 18px; padding-bottom: 3px; height: 36.333334px;"  >Download Invoice</a>
    ...
    <script>
        function customizeInvoice(enquiry) {
            ...
            document.getElementById('customizeinvoiceForm').action = `./driver-customize-invoice/${enquiry.enquiry_id }`;
