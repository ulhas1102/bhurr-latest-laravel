        ...
        <div class="row flex-grow">
          <div class="col-lg-6 d-flex align-items-center justify-content-center">
            <div class="auth-form-transparent text-left p-3">
              ...
              <form class="pt-3" method="POST" action="{{ route('dashboard.login') }}">
                @csrf
          ...
          <div class="col-lg-6 login-half-bg d-flex flex-row">
         	<p class="text-white font-weight-medium text-center flex-grow align-self-end">© 2024 Bhurr Technologies LLP. All rights reserved.</p>
          </div>
        </div>
      </div>
