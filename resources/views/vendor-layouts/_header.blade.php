    ...
    <div class="container-fluid">
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-between">
        ...
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
            <a class="navbar-brand brand-logo" href="{{url('vendor-dashboard')}}">
        ...
        <ul class="navbar-nav navbar-nav-right d-none">
            ...
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" id="profileDropdown">
                <span class="nav-profile-name"> {{ Auth::guard('vendor')->user()->name }}</span>
  ...
  <nav class="bottom-navbar">
    <div class="container">
        <ul class="nav page-navigation">
          ...
          <li class="nav-item">
              <a href="{{url('new-enquiries')}}" class="nav-link">
              ...
              <div class="submenu">
                  <ul>
                      <li class="nav-item"><a class="nav-link" href="{{url('all-bookings')}}">All Bookings</a></li>
                      <li class="nav-item"><a class="nav-link" href="{{url('all-ongoing-bookings')}}">On Gong Bookings</a></li>
                      <li class="nav-item"><a class="nav-link" href="{{url('all-complete-bookings')}}">Completed Bookings</a></li>
                      <li class="nav-item"><a class="nav-link" href="{{url('all-cancelled-bookings')}}">Cancelled Bookings</a></li>
                  </ul>
              </div>
          </li>
        ...
        <li class="nav-item">
          ...
          <div class="submenu">
              <ul>
                  <li class="nav-item"><a class="nav-link" href="{{url('drivers')}}">All Driver</a></li>
                  <li class="nav-item"><a class="nav-link" href="{{url('add')}}">Add Driver</a></li>
              </ul>
          </div>
      </li>
         
          <li class="nav-item">
              <a href="{{route('vendors-cars')}}" class="nav-link">
                <i class="mdi mdi-car menu-icon"></i>
                <span class="menu-title">Available cars</span>
                <i class="menu-arrow"></i>
              </a>
              <div class="submenu">
                  <ul class="submenu-item">
                      <li class="nav-item"><a class="nav-link" href="{{route('vendors-cars')}}">Available cars</a></li>
                      <li class="nav-item"><a class="nav-link" href="{{route('add-cars')}}">Add cars</a></li>
                  </ul>
              </div>
          </li>
