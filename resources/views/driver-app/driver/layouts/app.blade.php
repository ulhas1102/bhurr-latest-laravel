...
<body>
    ...
    <div class="container-scroller">
        ...
        <div class="horizontal-menu">
                ...
                <div class="container-fluid">
                    <div class="navbar-menu-wrapper d-flex align-items-center justify-content-between">
                        ...
                        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                            <a class="navbar-brand brand-logo" href="/driver/dashboard"><img
                                    src="{{ asset('assets/images/bhurr-logo.png')}}" alt="logo" /></a>
                            <a class="navbar-brand brand-logo-mini" href="/driver/dashboard"><img
                                    src="{{ asset('assets/images/bhurr-logo.png')}}" alt="logo" /></a>
                        </div>
                  ...
                  <button type="button" class="btn btn-inverse-primary btn-sm">Settings</button>
                            ...
                            <li class="nav-item nav-profile">
                                ...
                                <span class="nav-profile-name">
                                    <img src="{{ asset('assets/driver_images/' . Auth::guard('driverLogin')->user()->profile_image) }}"
                                        alt="profile" />
                                    {{ Auth::guard('driverLogin')->user()->first_name }}</span>
                            ...
                            <li class="nav-item dropdown d-lg-flex d-none">
                                <a class="dropdown-item" href="{{url('driverLogout')}}">
            ...
            @include('driver-app.driver.layouts.header')
        </div>
        <!-- partial -->
        ...
        <!-- @include('driver-app.driver.layouts.footer') -->
