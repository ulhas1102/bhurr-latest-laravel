...
@section('title', 'One Way Fare Management')
                ...
                <table class="table display" style="width:100%" id="example">
                  ...
                  <tbody>
                   ...
                   @foreach($carclasses as $carclass)
                    <tr>
                    <td>{{$i++}}</td>
                     <td><a href="one-way-price-group?class_id={{$carclass->carclass_id}}">{{$carclass->car_class}}</a></td>
                    <td>
              ...
              <form id="editFaremanagementForm" method="POST">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="editPerKMCharges" name="per_km_charges" required>
                        ...
                        <div class="form-group">
                            <label for="editOnewayDiselPerKMCharges">One way Disel/petrol Per Km Charges<small>(In Rupees)</small></label>
