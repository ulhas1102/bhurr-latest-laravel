      ...
      <div class="row">
        <div class="card">
            <div class="card-header d-flex  justify-content-between p-3">
              <h4>Outstation Price Group for {{$carclass->car_class}} class</h4>
              <button type="button" class="btn btn-primary" onclick="AddCity({{ json_encode($_GET['class_id']) }})">
                Add City
              </button>
				<a class="btn btn-primary" href="outstation-fare">Back</a>
            </div>
                ...
                <table class="table display" style="width:100%" id="example">
                  <thead>
                    <tr>
                        ...
                        <th>Per km price</th>
                        <th>Outstation CNG Per km price</th>
                        <th>Outstation Diesel/Petrol Per km price</th>
                        <th>Outstation Electric Per km price</th>
                  ...
                  <tbody>
                   ...
                   @foreach($priceGroups as $priceGroup)
                    ...
                    <td>
                      @if($priceGroup->outstation_cng_per_km_charges != null)
                      {{$priceGroup->outstation_cng_per_km_charges}}
                      @else
                      - 
                     @endif
                    </td>
                    <td>
                      @if($priceGroup->outstation_disel_per_km_charges != null)
                      {{$priceGroup->outstation_disel_per_km_charges}}
                      @else
                      - 
                     @endif
                    </td>
                    ...
                    <td>
                      @if($priceGroup->outstation_base_fare != null)
                      {{$priceGroup->outstation_base_fare}}
                      @else
                      - 
                    @endif
                    </td>
          ...
          <div class="modal-body">
              <form id="editFaremanagementForm" method="POST">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="editOutstationDiselPerKMCharges">Outstation Diesel/Petrol Per Km Charges<small>(In Rupees)</small></label>
                    <input type="text" class="form-control" id="editOutstationDiselPerKMCharges" placeholder="Enter Disel/Petrol per km  charges" name="outstation_disel_per_km_charges" required>
                  </div>

                  <div class="form-group">
                    <label for="editOutstationCngPerKMCharges">Outstation CNG Per Km Charges<small>(In Rupees)</small></label>
                    <input type="text" class="form-control" id="editOutstationCngPerKMCharges" placeholder="Enter CNG per km  charges" name="outstation_cng_per_km_charges" required>
                  </div>
                  <div class="form-group">
                    <label for="editOutstationElecticPerKMCharges">Outstation Electric Per Km Charges<small>(In Rupees)</small></label>
                    <input type="text" class="form-control" id="editOutstationElecticPerKMCharges" placeholder="Enter Electric per km  charges" name="electric_per_km_charges" required>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="editOutstationBaseFare" placeholder="Enter Base Fare" name="outstation_base_fare" required>
                  </div>
...
<script>
    function editFareManagement(priceGroup) {
        ...
        document.getElementById('editOutstationDiselPerKMCharges').value = priceGroup.outstation_disel_per_km_charges;
        document.getElementById('editOutstationCngPerKMCharges').value = priceGroup.outstation_cng_per_km_charges;
        ...
        document.getElementById('editOutstationBaseFare').value = priceGroup.outstation_base_fare;
