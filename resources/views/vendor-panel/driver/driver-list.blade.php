      ...
      <div class="row">
        <div class="card">
            <div class="card-header d-flex  justify-content-between p-3">
              <h4>Driver List</h4>
                <a href="{{url('add')}}" class="btn btn-primary">Add Driver</a>
            </div>
                ...
                <table class="table display" style="width:100%" id="example2">
                  ...
                  <tbody>
                    ...
                    <td class="d-flex justify-content-between">
                        <a href="drivers-details?driver_id={{$driver->driver_id}}" class="btn btn-success">View</a>
                        <a href="edit?driver_id={{$driver->driver_id}}" class="btn btn-primary">Edit</a>
                        <form action="deleteVendorDriver" method="POST">
