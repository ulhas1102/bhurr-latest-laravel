...
<div class="main-panel">
    ...
    <form class="forms-sample" action="vendor-edit-booking" method="POST">
        @csrf
            ...
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputUsername1" placeholder="Customer Pincode" name="customer_pincode"  value="{{$enquiries->customer_pincode}}" readonly>
                  </div>
              </div>
            </div>
          </div>
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" id="exampleInputUsername1" name="driver_id" required>
                  ...
                  <button class="btn btn-light d-none">Cancel</button>
