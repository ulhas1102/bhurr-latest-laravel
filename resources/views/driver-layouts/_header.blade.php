      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justify-content-between">
        ...
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
            <a class="navbar-brand brand-logo" href="driver-dashboard">
              ...
              <h1>Bhurr</h1>--}}
			<img src="{{asset('frontend/assets/image/logo/Bhurr-New-Logo.png')}}" width="150px" height="auto" alt="logo">
            </a>
            <a class="navbar-brand brand-logo-mini" href="/">
              {{-- <img src="images/logo-mini.svg" alt="logo"/>
              <h1>Bhurr</h1> --}}
			<img src="{{asset('frontend/assets/image/logo/Bhurr-New-Logo.png')}}" width="75px" height="auto" alt="logo">
            </a>
        </div>
        <ul class="navbar-nav navbar-nav-right d-none">
            ...
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" id="profileDropdown">
                <span class="nav-profile-name"> {{ Auth::guard('driver')->user()->name }}</span>
              ...
              <div class="submenu">
                  <ul>
                    {{-- <li class="nav-item"><a class="nav-link" href="{{url('add-new-enquiry')}}">Add Bookings</a></li> --}}
                      <li class="nav-item"><a class="nav-link" href="{{url('all-new-enquiries')}}">All Bookings</a></li>
                      <li class="nav-item"><a class="nav-link" href="{{url('all-complete-enquiries')}}">Completed Bookings</a></li>
                      <li class="nav-item"><a class="nav-link" href="{{url('all-cancelled-enquiries')}}">Cancelled Bookings</a></li>
                  </ul>
              </div>
          </li>
          {{-- <li class="nav-item">
        ...
        {{-- <li class="nav-item">
          ...
          {{-- <li class="nav-item">
              <a href="{{route('fare-management')}}" class="nav-link">
                ...
                <span class="menu-title">Fare Management</span></a>
          </li> --}}
        </ul>
    </div>
  </nav>